...
namespace WDT_Assignment2.Controllers
{
    public class AccountsController : Controller
    {
        ...
        {
            var nwbaContext = _context.Accounts.Include(a => a.Customer);
        ...
        public async Task<IActionResult> Create([Bind("AccountNumber,AccountType,CustomerID,Balance")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountNumber,AccountType,CustomerID,Balance")] Account account)
        {
